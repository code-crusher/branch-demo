...
function uc(a){Jb(document.body,"branch-banner-is-active");Yb&&"fixed"===Xb&&Jb(document.body,"branch-banner-no-scroll");setTimeout(function(){"top"===O?a.style.top="0":"bottom"===O&&($b=!0,document.getElementById("branch-banner-iframe").style.transition="all 0s",vc(!1,!0),window.addEventListener("resize",wc),window.addEventListener("scroll",xc));N(S,"didShowJourney",T);kc=!0},20)}function wc(){$b&&vc(!1,!1)}function xc(){$b&&(window.pageYOffset>window.innerHeight?vc(!0,!1):vc(!1,!1))}
function vc(a,b){var c=document.getElementById("branch-banner-iframe"),d=c.offsetHeight,e=c.offsetTop,f=window.innerHeight;b&&window.pageYOffset?c.style.bottom="0":a?c.style.top=f-d+d/2+"px":f-e!=d&&(c.style.top=""+(f-d)+"px")}function yc(a){a=a.globalDismissPeriod;if("number"===typeof a){if(-1===a)a=!0;else{var b=new Date;a=b.setSeconds(b.getSeconds()+a)}return a}}
